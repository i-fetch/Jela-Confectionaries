...
export default async function Page() {
  ...
  return (
    <div>
      <Navbar />
      <header 
        className="pb-20 relative bg-fixed bg-bottom bg-cover bg-no-repeat h-[50vh] md:h-[45vh] lg:h-[50vh] overflow-hidden"
      ...
      >
        ...
        <div className='absolute inset-0 z-20 flex flex-col items-center justify-center h-full pt-20 px-4 md:pb-20'>
          ...
          <p className='text-gray-300 text-xs xl:text-2xl font-medium space-x-1.5'>
            <span>Home</span>/ <span>Menu</span>
          </p>
        </div>
      </header>

      {/* Pass fetched products to Menu2 */}
